...
<p>
    ...
    carefully before using the https://r.codes website (the "Service") operated
    by Vaionex Corporation ("us", "we", or "our").
</p>
<p>
...
<p>
    <strong>Sales &amp; Purchases</strong>
</p>
<p>
    If you wish to sale or purchase any product or service made available
...
<p>
    ...
    you or any third party posts on or through the Service. However, by posting
    Content using the Service you grant us the right and license to use,
    modify, publicly perform, publicly display, reproduce, and distribute such
    Content on and through the Service. You agree that this license includes
...
<p>
    Vaionex Corporation has the right but not the obligation to monitor and
    edit all Content provided by users.
</p>
<p>
    In addition, Content found on or through this Service are the property of
    Vaionex Corporation or used with permission. You may not distribute,
    ...
    without express advance written permission from us. R.codes owns the
    content that it has put on R.codes (unless otherwise stated and excluding
    content owned by others). This includes the design, compilation, and look
    and feel of the R.codes site, and copyright, trademarks, designs and other
...
<p>
    ...
    age of 18, and that the information (including your eMail address) you
    provide us is accurate, complete, and current at all times. Inaccurate,
    incomplete, or obsolete information may result in the immediate termination
...
<p>
    ...
    whether your password is with our Service or a third-party service. You are
    responsible for any use of the R.codes site that occurs in conjunction with
    your username and password. You must notify us immediately upon becoming
    aware of any breach of security or unauthorized use of your account. Your
...
<p>
    ...
    copyright@r.codes, with the subject line: "Copyright Infringement" and
...
<p>
You can contact our Copyright Agent via email at    <a href="mailto:copyright@r.codes">copyright@r.codes</a>.
</p>
<p>
    <strong>Privacy</strong>
</p>
<p>
    As a member of R.Codes you will be asked to provide information about
    yourself. This information may be used by us and contractors in connection
    with providing the R.codes sites and their services, including marketing
    activities. More information can be found in the <em>Privacy Policy</em>.
</p>
<p>
    R.codes value your information and take reasonable precautions to protect
    it as confidential information. While R.codes takes reasonable steps to
    protect your information, please be aware that R.codes cannot promise that
    your use of the R.codes platform will be confidential, and R.codes cannot
    guarantee that any information you provide to R.codes is perfectly secure.
    While using the R.codes, you may also become aware of confidential
    information about us or another member. You promise to not disclose any
    confidential information made available to you through the R.codes to any
    other person.
</p>
<p>
...
<p>
    ...
    not owned or controlled by Vaionex Corporation.
</p>
<p>
    Vaionex Corporation has no control over, and assumes no responsibility for
...
<p>
    You acknowledge and agree that Vaionex Corporation shall not be responsible
...
<p>
    You agree to defend, indemnify and hold harmless Vaionex Corporation and
...
<p>
    We provide the R.codes site, not the items on the R.codes site. In no event
    shall Vaionex Corporation, nor its directors, employees, partners, agents,
...
<p>
    Vaionex Corporation its subsidiaries, affiliates, and its licensors do not
...
<p>
    R.codes and its affiliates, subsidiaries, officers, directors, employees,
    agents, partners, and licensors (summarized here as “R.codes”) do not
    promise that the site, content, services or any other information or
    materials that you receive (including functionality or features, summarized
    here as “service(s)”) will be accurate, reliable, timely, secure,
    error-free or uninterrupted, or that any defects will be corrected. R.codes
    ...
    contamination or destructive features. R.codes does not guarantee any
    results or identification or correction of problems as part of the service
    and R.codes disclaims any liability related to that. Furthermore, R.codes
    disclaims all warranties, express or implied, including all warranties of
    accuracy, non-infringement, merchantability and fitness for a particular
    purpose. R.codes disclaims any and all liability for the acts, omissions
    and conduct of any third parties in connection with or related to your use
    of the service. You assume total responsibility and all risks for your use
    of the service, including but not limited to, any information obtained
    thereon. Your sole remedy against R.codes for dissatisfaction with the
    provided service is to stop using the service. This limitation of relief is
    a part of the bargain between the parties. To the extent that R.codes makes
    any pre-release software or other products, services or information related
    thereto, you understand that R.codes is under no obligation to provide
    updates, enhancements, or corrections, or to notify you of any product or
    services changes that R.codes may make, or to publicly announce or
...
<p>
    Words like 'include' and 'including' are not words of limitation and where
    anything is within R.Code’s discretion we mean our sole discretion.
</p>
<p>
...
<p>
    <em>Last updated: January 04, 2017</em>
</p>
<p>
    R.Codes ("us", "we", or "our") operates https://r.codes (the "Site"). This
...
<p>
    This Privacy Policy is effective as of January 04, 2017 and will remain in
...
<p>
    If you have any questions about this Privacy Policy, please contact us.
                ...
                <Card className="policyCard">
                <p>
    <strong>Standard competition Terms &amp; conditions </strong>
</p>
<p>
    <strong> </strong>
</p>
...
<p>
    These standard terms and conditions are subject to any other terms and
    conditions provided to you or to which you are referred at the time of
    entering the competition.
</p>
<p>
    The Promoter is the Vaionex Corporation, 122 Stuart Dr, 19901-5825 Dover
    DE, USA.
</p>
<p>
...
<p>
    Entry is open to registered R.Codes users except employees (and their
    families) of Vaionex Corporation, its printers and agents, the suppliers of
    the prizes and any other companies associated with the competitions.
</p>
<p>
    The entrant(s) must be aged 18 or over. Proof of identity and age may be
    required. Use of a false name or address will result in disqualification.
</p>
<p>
    All entries must be made directly by the person entering the competition.
</p>
<p>
    Entries made online using methods generated by a script, macro or the use
    of automated devices will be void.
</p>
<p>
    No responsibility can be accepted for entries lost, delayed or corrupted,
    or due to computer error in transit.
</p>
<p>
    No cash alternative to the prizes will be offered. The prizes are not
    transferable. Prizes are subject to availability and we reserve the right
    to substitute any prize with another of equivalent value without giving
    notice.
</p>
<p>
    ...
    documents, passports and visas. Prizes are subject to availability and the
    prize suppliers' terms and conditions.
</p>
<p>
    The promoters reserve the right to amend or alter the terms of competitions
    and reject entries from entrants not entering into the spirit of the
    competition.
</p>
<p>
    In the event of a prize being unavailable, the promoter reserves the right
    to offer an alternative prize of equal or greater value.
</p>
<p>
    The winner(s) agree(s) to the use of their name, photograph and disclosure
    of county of residence and will co-operate with any other reasonable
    requests by Vaionex Corporation, relating to any post-winning publicity.
</p>
<p>
    Unless stated otherwise all postal entries must be made on the relevant
    coupon or form printed in the magazine or on the website.
</p>
<p>
    Unless stated otherwise the winner(s) will be drawn at random from all
    correct entries received by the closing date stated within the promotional
    material.
</p>
<p>
    Reasonable efforts will be made to contact the winner(s). If the winner(s)
    cannot be contacted, or are unable to comply with these terms and
    conditions, the Promoter reserves the right to offer the prize to the next
    eligible entrant drawn at random, or in the event that the promotion is
    being judged the Promoter reserves the right to offer the prize to the
    runner(s)-up selected by the same judges.
</p>
<p>
...
<p>
    The promoter is not responsible for inaccurate prize details supplied to
...
<p>
    Failure to respond and/or provide an address for delivery, or failure to
    meet the eligibility requirements may result in forfeiture of the prize.
</p>
<p>
    ...
    this decision. Competitions may be modified or withdrawn at any time.
</p>
<p>
...
<p>
    ...
    and the details in the promotional material (or any other terms and
    conditions provided/referred to at the time of entry), the details of the
    promotional material (and any other terms and conditions provided/referred
    to at the time of entry) shall prevail.
</p>
<p>
    A list of winners will be available by writing into the publisher of the
    magazine or website at the Promoter's address no earlier than six weeks
    (unless otherwise stated) after the close of the competition. Only the
    surname and county of the winners will be disclosed.
</p>
<p>
    ...
    providing your information to R.codes and Vaionex Corporation and not to
    any other party. The information provided will be used in conjunction with
    the Privacy Policy found at https://r.codes.
    <br/>
</p>
                </Card>
                <Card className="policyCard">
...
<p>
    R.Codes ("us", "we", or "our") uses cookies on https://r.codes (the
    "Service"). By using the Service, you consent to the use of cookies.
</p>
<p>
    Our Cookies Policy explains what cookies are, how we use cookies, how third
    parties
</p>
<p>
    we may partner with may use cookies on the Service, your choices regarding
...
<p>
    <strong>How R.codes uses cookies</strong>
</p>
<p>
...
<p>
    browser. We use cookies for the following purposes: to enable certain
    functions of the Service, to provide analytics, to store your preferences,
...
<p>
    ...
    We may use essential cookies to authenticate users and prevent fraudulent
    use of user accounts.
</p>
<p>
    <em>Third party cookies. </em>
In addition to our own cookies, we may also use various third parties    <em></em>
</p>
<p>
