    ...
    render(){
        ...
        if(Usercreatedproductobject == false) {
            ...
            <div>
                ...
                <p> This is the section where all your projects will appear, but you dont have any project created yet. <br/> <Link to="/Create"> <RaisedButton style={{marginTop: 20}}label="Introduction Page" /> </Link> </p>
                </Card>
            </div>
